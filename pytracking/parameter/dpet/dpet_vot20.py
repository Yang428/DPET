...
def parameters():
    ...
    params.segm_net_path = '/home/wcz/Yang/DPET/pytracking/networks/DPETNet.pth.tar'
    ...
    params.tracking_confidence_thr = 0.4   # Relative threshold to save the confidence scores
