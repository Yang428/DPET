...
def local_env_settings():
    ...
    settings.network_path = '/home/wcz/Yang/DPET/pytracking/networks/'    # Where tracking networks are stored.
    settings.nfs_path = '/media/wcz/datasets/yang/benchmarks/NFS/'
    settings.otb_path = '/media/wcz/datasets/yang/benchmarks/OTB100/'
    settings.results_path = '/home/wcz/Yang/DPET/pytracking/tracking_results/'    # Where to store tracking results
