...
class VOSDatasetBase(BaseVideoDataset):
    ...
    def get_sequence_info(self, sample_id):
        ...
        return m.get_shape(seq_name), visible

    def get_sequence_info1(self, sample_id):
        """ Get sample meta data.
        :param sample_id:  Sample to query.
        :return: dict of metadata:
                sequence:    Sequence name
    ...
    def get_frames(self, sample_id, frame_ids, anno=None):
        ...
        meta = self.get_sequence_info1(sample_id)
        ...
        if not self.multiobj:
            ...
            obj_id = obj_ids[0]
            labels = [torch.Tensor(lb == int(obj_id)).numpy() for lb in labels]
        ...
        return images, anno_frames['mask'], anno_frames['bbox'], object_meta
